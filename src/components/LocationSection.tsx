...
export default function LocationSection({ locations, onRefresh, viewMode }: Props) {
  ...
  return (
    <section className="bg-white p-8 rounded-lg shadow-sm border border-stone-100">
      ...
      {viewMode === 'admin' ? (
        ...
        <div className="mb-8 p-4 bg-stone-50 border border-stone-100 text-[10px] uppercase font-bold text-stone-400 tracking-wider">
              ...
              <tr key={loc.id} className="hover:bg-stone-50 transition-colors">
                ...
                <td className="px-4 py-4 text-right">
                  {viewMode === 'admin' ? (
                    ...
                    <span className="text-[10px] text-stone-300 font-bold uppercase">Locked</span>
                  )}
                </td>
              </tr>
            ))}
